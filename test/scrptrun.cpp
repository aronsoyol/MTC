...
UChar32 ScriptRunIterator::pairedChars[] = {
...
const int32_t ScriptRunIterator::pairedCharCount = ARRAY_SIZE(pairedChars);
const int32_t ScriptRunIterator::pairedCharPower = 1 << highBit(pairedCharCount);
const int32_t ScriptRunIterator::pairedCharExtra = pairedCharCount - pairedCharPower;

int8_t ScriptRunIterator::highBit(int32_t value)
{
    if (value <= 0) {
        return -32;
    }
...
int32_t ScriptRunIterator::getPairIndex(UChar32 ch)
{
...
UBool ScriptRunIterator::sameScript(int32_t scriptOne, int32_t scriptTwo)
{
